...
class Settings:
    ...
    def set_settings(self):
        ...
        self.set_permission(settings.get('sr permission', Perms.ALL), save=False)
        ...
        self.set_leaderboard_reset(settings.get('leaderboard reset', Reset.OFF), save=False)
    ...
    def set_permission(self, permission, save=True):
        ...
        if permission not in ['all', 'subs', 'followers', 'privileged']:
            raise SettingsError('Permission must be either "all", "subs", "followers" or "privileged".')
